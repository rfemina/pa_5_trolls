		...
		<div class="row fRow">
			...
			<div class="col-xs-9 col-xs-offset-3 text-justify fMain">
				...
				<div class="bloco col-xs-6">
					<div class="card">
					    <div class="card-image waves-effect waves-block waves-light">
					    	<a href="relatorioDiario.php" target="_blank"><img src="../IMG/relatorio1.png"></a>
					   	</div>
					  	<div class="card-content">
				      		<span class="card-title activator grey-text text-darken-4">Diário</span>
				      		<p><a href="relatorioDiario.php" target="_blank">Acesse agora</a></p>
					   	</div>
					</div>
				</div>
				<!-- BLOCO SEMANAL -->
				<div class="bloco col-xs-6">
					<div class="card">
					    <div class="card-image waves-effect waves-block waves-light">
					    	<a href="relatorioSemanal.php" target="_blank"><img src="../IMG/relatorio7.png"></a>
					   	</div>
					  	<div class="card-content">
				      		<span class="card-title activator grey-text text-darken-4">Semanal</span>
				      		<p><a href="relatorioSemanal.php" target="_blank">Acesse agora</a></p>
					   	</div>
					</div>
				</div>
				<!-- BLOCO AGENDAMENTO -->
				<div class="bloco col-xs-6">
					<div class="card">
					    <div class="card-image waves-effect waves-block waves-light">
					    	<a href="relatorioQuinzenal.php" target="_blank"><img src="../IMG/relatorio15.png"></a>
					   	</div>
					  	<div class="card-content">
				      		<span class="card-title activator grey-text text-darken-4">Quinzenal</span>
				      		<p><a href="relatorioQuinzenal.php" target="_blank">Acesse agora</a></p>
					   	</div>
					</div>
				</div>
				<!-- BLOCO RELATÓRIO -->
				<div class="bloco col-xs-6">
					<div class="card">
					    <div class="card-image waves-effect waves-block waves-light">
					    	<a href="relatorioMensal.php" target="_blank"><img src="../IMG/relatorio30.png"></a>
					   	</div>
					  	<div class="card-content">
				      		<span class="card-title activator grey-text text-darken-4">Mensal</span>
				      		<p><a href="relatorioMensal.php" target="_blank">Acesse agora</a></p>
					   	</div>
					</div>
				</div>
			</div>
