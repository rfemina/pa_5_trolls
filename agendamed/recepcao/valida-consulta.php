<?php  
	...
	$insertConsulta = mysqli_query($conn, "INSERT INTO Consulta VALUES (NULL, '$nmConsulta', '$inicioCon', '$fimCon', '$semana', '1', '$cpf', $nmMedico, $nmEnfermeiro, '$ubs')") or die(mysqli_error($conn));
?>
<!doctype html>
<html lang = "pt-br">
<head>
		...
		<div class="row fRow">
			...
			<div class="col-xs-9 col-xs-offset-3 text-justify fMain">
				<div class="col-xs-12 branco sombra cadastroPront">
					<h1 class="text-center">Consulta cadastrada com sucesso.</h1>	
					<center>
						<div class="row">
							<div class="col-xs-12">
						...
						<div class="row">
							...
							<a class="btn btn-default" href="cadastrarConsulta.php" role="button">Cadastrar outra Consulta</a>
