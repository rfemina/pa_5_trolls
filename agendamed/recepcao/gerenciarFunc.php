		...
		<div class="row fRow">
			...
			<div class="col-xs-9 col-xs-offset-3 text-justify fMain">	
					...
					<div class="col-xs-12">
						...
						<form action="" method="post">
							...
							<table class="tbGerenciaPront">
									<tr>
										<td><label><input type="radio" name="optionsRadios" value="1" onClick="mudaRadio(1)"> Pesquisar por UBS</label></td>
				...
				<?php 
						...
						if ($op == 1) {
							if ($pesquisa != ""){
								$selectUbsF = mysqli_query($conn, "SELECT NM_Ubs, CD_Ubs FROM Ubs WHERE NM_Ubs LIKE '%$pesquisa%'") or die(mysqli_error($conn));
								...
								echo "<center><h4>Digite o nome de uma Unidade Básica de Saúde.</h2></center>";
							}							
						}		
